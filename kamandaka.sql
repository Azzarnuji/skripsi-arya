...
INSERT INTO `drivers` (`id`, `name`, `no_ktp`, `no_sim`) VALUES
(4, 'Arya Wirayuda', '12132343545', '2323243534535');
...
INSERT INTO `rental` (`id`, `idMobil`, `merk`, `pabrikan`, `tahun`, `hargaOne`, `hargaTwo`, `description`, `img`, `nomor_plat`, `nomor_rangka`, `nomor_mesin`, `kapasitas_mesin`, `tipe_bbm`, `status`) VALUES
...
CREATE TABLE `reviews` (
  ...
  `snippets` text COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('azzarnuzy93@gmail.com', '$2y$10$6FEm78bAHSk4Aeom9BWUS.5jwf30RMpTVOzwgQ2RHfFzYLihJu4vi', 'Azzaarnuji Nur Ukhrowi');
