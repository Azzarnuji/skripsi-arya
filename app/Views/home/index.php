	...
	<div class="container ">
		...
		<div class="owl-carousel">
			...
			<?php foreach ($daftarRental as $dr) : ?>
				<div class="blog-list has-scrollbar h-100">
					<div class="blog-card">

						<figure class="card-banner">

							<a href="<?= base_url("/rental/{$dr['idMobil']}"); ?>">
								<img src="<?= base_url('/assets/images/car/' . $dr['img']); ?>" style="height: 300px; width: auto;" alt="<?= $dr['merk']; ?>" loading="lazy" class="w-100">
							</a>

							<a href="<?= base_url("/rental/{$dr['idMobil']}"); ?>" class="btn card-badge">Pilih</a>
