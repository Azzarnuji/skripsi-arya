				...
				<tbody class="table-border-bottom-0">
					...
					<?php foreach ($cars as $car) : ?>
						<tr>
							...
							<td><?= $car['img'] ?></td>
							<td>
								<button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modalView">
									Lihat
								</button>
								<button class="btn btn-sm btn-warning" onclick="askBeforeExecution('Yakin Hapus Kendaraan ?',()=>{
									window.location.href = '/admin/hapusKendaraan/' + '<?= $car['idMobil'] ?>';
								})">
									Hapus
								</button>
							</td>
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-md-12 mb-3">
								...
								<input type="text" name="pabrikan" class="form-control" placeholder="Enter Name">
							</div>
							<div class="col-md-12 mb-3">
								<label for="nameWithTitle" class="form-label">Tahun Kendaraan</label>
								<input type="text" name="tahun" class="form-control" placeholder="Enter Name">
							</div>
							<div class="col-md-12 mb-3">
								<label for="nameWithTitle" class="form-label">Harga Lepas Kunci</label>
								<input type="text" name="hargaOne" class="form-control" placeholder="Enter Name">
							</div>
							<div class="col-md-12 mb-3">
								<label for="nameWithTitle" class="form-label">Harga All IN</label>
								<input type="text" name="hargaTwo" class="form-control" placeholder="Enter Name">
							</div>
							<div class="col-md-12 mb-3">
